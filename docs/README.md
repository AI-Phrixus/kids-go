...
| 文件 | 給誰看 |
|------|--------|
| **[HANDOFF.md](./HANDOFF.md)** | 新帳號／新 AI 接手（必讀） |
| **[STATUS.md](./STATUS.md)** | 進度快照（常更新） |
| [ROADMAP.md](./ROADMAP.md) | P0/P1/P2 |
| [LEARNING-SCIENCE.md](./LEARNING-SCIENCE.md) | 發展科學與設計約束 |
| [EYECARE.md](./EYECARE.md) | 護眼、休息儀式 |
